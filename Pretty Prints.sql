...
CREATE TABLE items(items_id integer, Title char(50), artist char(50),unit_price float, on_hand integer);
...
WHERE customers.customer_id = orders.customer_id AND orders.order_date >='2014-01-01';
